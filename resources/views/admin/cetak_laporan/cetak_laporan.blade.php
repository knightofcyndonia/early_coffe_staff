...
<div class="container-fluid">   
  ...
  <!-- SELECT2 EXAMPLE -->
  <form method="POST" action="{{url ('admin/cetak_laporan')}}">
  @csrf
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                    <input value="{{$date_from}}" type="text" class="form-control datetimepicker-input" data-target="#reservationdate" id="date_from" name="date_from"/>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group date" id="reservationdateto" data-target-input="nearest">
                    <input value="{{$date_to}}" readonly type="text" class="form-control datetimepicker-input" data-target="#reservationdateto" id="date_to" name="date_to"/>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{date_format(new DateTime($pemesanan['updated_at']),"d F Y")}}</td>
...
<!-- Bootstrap 4 -->
<script src="{{asset('')}}assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script><!-- DataTables -->
...
<script>
  $(function () {
    $('.datetimepicker-input').keypress(false);

    fnSetSelect();
    fnDataTable();
    $("#nav-item-cetak_laporan").addClass("active");
  ...
  function fnSetSelect()
  {
    ...
    //Date range picker
    $('#reservationdate, #reservationdateto').datetimepicker({
        format: 'YYYY-MM-DD',
        useCurrent:true
    });
    //Date range picker
